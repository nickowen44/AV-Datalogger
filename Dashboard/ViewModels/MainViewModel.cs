...
namespace Dashboard.ViewModels
{
    public partial class MainViewModel : ViewModelBase, IDisposable
    {
        ...
        public MainViewModel()
        {
            ...
            SelectedListItem = Items.FirstOrDefault(vm => vm.View == typeof(ConnectionView)) ?? throw new InvalidOperationException("No matching item found.");
        }
        ...
        partial void OnSelectedListItemChanged(ListItemTemplate value)
        {
            ...
            if (!_views.ContainsKey(value.Label))
            {
                ...
                {
                    Console.WriteLine("Failed to load view instance");
                }
                else
                {
