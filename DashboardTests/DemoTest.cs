...
public class DemoTest
{
    ...
    // TODO IDK how to test bad yaml cause you send in the data context which has the yaml data that would have been already adjusted by the view model, so it is not replicatable (i think) by tests
}